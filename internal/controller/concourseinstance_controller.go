...
const instanceFinalizer = "concourse.concourse-ci.org/instance-finalizer"

// ConcourseInstanceReconciler reconciles a ConcourseInstance object.
type ConcourseInstanceReconciler struct {
	client.Client
	Scheme *runtime.Scheme
	Cache  *concourse.Cache
}

// +kubebuilder:rbac:groups=concourse.concourse-ci.org,resources=concourseinstances,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=concourse.concourse-ci.org,resources=concourseinstances/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=concourse.concourse-ci.org,resources=concourseinstances/finalizers,verbs=update
// +kubebuilder:rbac:groups="",resources=secrets,verbs=get;list;watch

func (r *ConcourseInstanceReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
...
func (r *ConcourseInstanceReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&concoursev1alpha1.ConcourseInstance{}).
		Named("concourseinstance").
		Complete(r)
}
