...
const teamFinalizer = "concourse.concourse-ci.org/team-finalizer"

// ConcourseTeamReconciler reconciles a ConcourseTeam object.
type ConcourseTeamReconciler struct {
	client.Client
	Scheme *runtime.Scheme
	Cache  *concourse.Cache
}

// +kubebuilder:rbac:groups=concourse.concourse-ci.org,resources=concourseteams,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=concourse.concourse-ci.org,resources=concourseteams/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=concourse.concourse-ci.org,resources=concourseteams/finalizers,verbs=update
// +kubebuilder:rbac:groups=concourse.concourse-ci.org,resources=concourseinstances,verbs=get;list;watch

func (r *ConcourseTeamReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
...
func (r *ConcourseTeamReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&concoursev1alpha1.ConcourseTeam{}).
		Named("concourseteam").
		Complete(r)
}
