...
// ConcourseBuildReconciler reconciles a ConcourseBuild object.
type ConcourseBuildReconciler struct {
	client.Client
	Scheme *runtime.Scheme
	Cache  *concourse.Cache
}

// +kubebuilder:rbac:groups=concourse.concourse-ci.org,resources=concoursebuilds,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=concourse.concourse-ci.org,resources=concoursebuilds/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=concourse.concourse-ci.org,resources=concoursebuilds/finalizers,verbs=update
// +kubebuilder:rbac:groups=concourse.concourse-ci.org,resources=concoursejobs,verbs=get;list;watch
// +kubebuilder:rbac:groups=concourse.concourse-ci.org,resources=concoursepipelines,verbs=get;list;watch
// +kubebuilder:rbac:groups=concourse.concourse-ci.org,resources=concourseteams,verbs=get;list;watch

func (r *ConcourseBuildReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if build.Status.BuildID != 0 {
		...
		if err != nil {
			...
			build.Status.ConcourseStatus = concoursev1alpha1.BuildStatus(atcBuild.Status)
...
func isTerminal(s concoursev1alpha1.BuildStatus) bool {
	switch s {
	case concoursev1alpha1.BuildStatusSucceeded, concoursev1alpha1.BuildStatusFailed,
		concoursev1alpha1.BuildStatusErrored, concoursev1alpha1.BuildStatusAborted:
		return true
	}
	return false
}
...
func (r *ConcourseBuildReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&concoursev1alpha1.ConcourseBuild{}).
		Named("concoursebuild").
		Complete(r)
}
