...
// ConcourseWorkerReconciler reconciles a ConcourseWorker object.
type ConcourseWorkerReconciler struct {
	client.Client
	Scheme *runtime.Scheme
	Cache  *concourse.Cache
}

// +kubebuilder:rbac:groups=concourse.concourse-ci.org,resources=concourseworkers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=concourse.concourse-ci.org,resources=concourseworkers/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=concourse.concourse-ci.org,resources=concourseworkers/finalizers,verbs=update
// +kubebuilder:rbac:groups=concourse.concourse-ci.org,resources=concourseinstances,verbs=get;list;watch

func (r *ConcourseWorkerReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
...
func (r *ConcourseWorkerReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&concoursev1alpha1.ConcourseWorker{}).
		Named("concourseworker").
		Complete(r)
}
