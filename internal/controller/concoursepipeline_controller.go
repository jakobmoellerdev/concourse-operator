...
const pipelineFinalizer = "concourse.concourse-ci.org/pipeline-finalizer"

// ConcoursePipelineReconciler reconciles a ConcoursePipeline object.
type ConcoursePipelineReconciler struct {
	client.Client
	Scheme *runtime.Scheme
	Cache  *concourse.Cache
}

// +kubebuilder:rbac:groups=concourse.concourse-ci.org,resources=concoursepipelines,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=concourse.concourse-ci.org,resources=concoursepipelines/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=concourse.concourse-ci.org,resources=concoursepipelines/finalizers,verbs=update
...
func (r *ConcoursePipelineReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
...
func (r *ConcoursePipelineReconciler) loadPipelineConfig(ctx context.Context, pipeline *concoursev1alpha1.ConcoursePipeline) ([]byte, error) {
...
func (r *ConcoursePipelineReconciler) deletePipeline(ctx context.Context, pipeline *concoursev1alpha1.ConcoursePipeline) error {
	cl, teamName, err := resolveClientForPipeline(ctx, r.Client, r.Cache, pipeline)
	if err != nil {
		return err
	}
...
func (r *ConcoursePipelineReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&concoursev1alpha1.ConcoursePipeline{}).
		Named("concoursepipeline").
		Complete(r)
}
