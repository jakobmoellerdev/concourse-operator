...
// ConcourseResourceReconciler reconciles a ConcourseResource object.
type ConcourseResourceReconciler struct {
	client.Client
	Scheme *runtime.Scheme
	Cache  *concourse.Cache
}

// +kubebuilder:rbac:groups=concourse.concourse-ci.org,resources=concourseresources,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=concourse.concourse-ci.org,resources=concourseresources/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=concourse.concourse-ci.org,resources=concourseresources/finalizers,verbs=update
...
func (r *ConcourseResourceReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	log := logf.FromContext(ctx)

	resource := &concoursev1alpha1.ConcourseResource{}
...
func shouldCheck(resource *concoursev1alpha1.ConcourseResource) bool {
	if resource.Spec.CheckInterval == nil {
		return false
	}
...
func (r *ConcourseResourceReconciler) fetchLatestVersion(team goconcourse.Team, pipelineName, resourceName string, resource *concoursev1alpha1.ConcourseResource) error {
...
func (r *ConcourseResourceReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&concoursev1alpha1.ConcourseResource{}).
		Named("concourseresource").
		Complete(r)
}
