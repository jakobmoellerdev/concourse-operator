...
// ConcourseInstanceSpec defines the desired state of ConcourseInstance.
type ConcourseInstanceSpec struct {
...
// ConcourseInstanceStatus defines the observed state of ConcourseInstance.
type ConcourseInstanceStatus struct {
	// +listType=map
	// +listMapKey=type
	// +optional
...
// ConcourseInstance represents a connection to a Concourse CI server.
type ConcourseInstance struct {
	...
	// +required
	Spec ConcourseInstanceSpec `json:"spec"`

	// +optional
	Status ConcourseInstanceStatus `json:"status,omitzero"`
}

// +kubebuilder:object:root=true

// ConcourseInstanceList contains a list of ConcourseInstance.
type ConcourseInstanceList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitzero"`
	Items           []ConcourseInstance `json:"items"`
}

func init() {
	SchemeBuilder.Register(&ConcourseInstance{}, &ConcourseInstanceList{})
}
