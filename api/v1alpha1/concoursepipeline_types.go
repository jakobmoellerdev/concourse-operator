...
// ConcoursePipelineSpec defines the desired state of ConcoursePipeline.
type ConcoursePipelineSpec struct {
	// TeamRef references the ConcourseTeam this pipeline belongs to.
...
// ConcoursePipelineStatus defines the observed state of ConcoursePipeline.
type ConcoursePipelineStatus struct {
	// +listType=map
	// +listMapKey=type
	// +optional
...
// ConcoursePipeline manages a Concourse pipeline configuration.
type ConcoursePipeline struct {
	...
	// +required
	Spec ConcoursePipelineSpec `json:"spec"`

	// +optional
	Status ConcoursePipelineStatus `json:"status,omitzero"`
}

// +kubebuilder:object:root=true

// ConcoursePipelineList contains a list of ConcoursePipeline.
type ConcoursePipelineList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitzero"`
	Items           []ConcoursePipeline `json:"items"`
}

func init() {
	SchemeBuilder.Register(&ConcoursePipeline{}, &ConcoursePipelineList{})
}
